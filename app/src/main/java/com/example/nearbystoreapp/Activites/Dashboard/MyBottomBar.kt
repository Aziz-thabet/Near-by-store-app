package com.example.nearbystoreapp.Activites.Dashboard
...
@Preview
fun MyBottomBar() {
    val bottomMenuItemsList = PreparBottomMenu()
                ...
                onClick = {
                    ...
                    Column (horizontalAlignment = Alignment.CenterHorizontally){
                        Icon(painter = bottomMenuItems.icon,
                            ...
                            tint = colorResource(R.color.darkBrawn),
                            modifier = Modifier.padding(top = 8.dp).size(20.dp)
                            )
                        Text(
                            text = bottomMenuItems.label,
                            fontSize = 12.sp,
                            color = colorResource(R.color.darkBrawn),
...
@Composable
fun PreparBottomMenu(): List<BottomMenuItem> {
