package com.example.nearbystoreapp.Map
...
import com.example.nearbystoreapp.Activites.Results.ItemsNearest
...
fun MapScreen(latLng: LatLng,item: StoreModel){
    val cremerPostionState= rememberCameraPositionState{
    ...
    ConstraintLayout() {
        ...
        GoogleMap(modifier = Modifier
            ...
            cameraPositionState = cremerPostionState
        ) {
